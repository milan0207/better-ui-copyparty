...
Ls.kor = {
	...
	"ct_grid": "그리드",
	"ct_ttips": '◔ ◡ ◔">도움말',
	"ct_thumb": '그리드 보기에서 아이콘 또는 미리보기 이미지 전환$N단축키: T">미리보기',
	...
	"mt_fau": "폰에서 다음 곡이 충분히 빨리 미리 불러오지 않아 음악이 멈추는 것을 방지합니다 (태그 표시가 불안정해질 수 있음).\">",
	...
	"tvt_edit": "텍스트 편집기에서 파일 열기$N단축키: E\">편집",
