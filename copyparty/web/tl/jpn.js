...
Ls.jpn = {
	...
	"ct_grid": 'グリッド',
	"ct_ttips": '◔ ◡ ◔">ツールチップ',
	"ct_thumb": 'グリッドビューではアイコンまたはサムネイルを切り替える$Nホットキー: T">サムネイル',
	...
	"mt_fau": "携帯電話では、次の曲が十分に早く読み込まれない場合に音楽が停止しないようにする（タグの表示が不安定になる可能性があります）\">",
	...
	"tvt_edit": "テキストエディタでファイルを開く$Nホットキー: E\">編集",
