...
Ls.ukr = {
	...
	"ct_grid": 'сітка',
	"ct_ttips": '◔ ◡ ◔">підказки',
	"ct_thumb": 'у режимі сітки, перемкнути іконки або мініатюри$NГаряча клавіша: T">мініатюри',
	...
	"mt_one": "зупинити після однієї пісні\">1",
	...
	"mt_fau": "на телефонах, запобігти зупинці музики, якщо наступна пісня не завантажується достатньо швидко (може зробити відображення тегів глючним)\">",
	...
	"tvt_edit": "відкрити файл в текстовому редакторі$NГаряча клавіша: E\">редагувати",
